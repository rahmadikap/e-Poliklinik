    ...
    <div class="login-container">
        ...
        <div class="right-container">
            <div class="login-form">
                ...
                <p class="login-box-msg text-center">Lakukan login <b class="text-success">ADMIN</b></p>
                <br><br>
            ...
            <div class="text-center mt-3">
                <a href="index.php"><span class="text-primary">Anda Bukan ADMIN? klik disini</span></a>
            </div>
        </div>
    </div>
